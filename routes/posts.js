...
// IMPORTANT : Here since we are not using the ajax request, so we can send a get request even for deleting the post, but when we will be using ajax request we will be using the DELETE method compulsorily.
